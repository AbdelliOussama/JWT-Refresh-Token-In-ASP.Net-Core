...
namespace ResourceClient
{
    public class Program
    {
        ...
        private static readonly string AuthServerBaseUrl = "http://localhost:5043"; // Authentication Server URL
        private static readonly string ResourceServerBaseUrl = "http://localhost:5225"; // Replace with your Resource Server's URL and port
